...
public class WebTechStudent extends JFrame {

    JPanel contentPanel;

    WebTechStudent() {

        setTitle("Web Technology Questions");
        ...
        // 🔷 Heading
        JLabel heading = new JLabel("Important Web Technology Questions");
        heading.setFont(new Font("Tahoma", Font.BOLD, 38));
        heading.setForeground(Color.WHITE);
        heading.setBounds(500, 40, 1400, 50);
        banner.add(heading);
    ...
    void loadQuestions() {
        ...
        try {
            ...
            ResultSet rs = c.statement.executeQuery(
                "SELECT * FROM webtech_questions ORDER BY id DESC"
            );
