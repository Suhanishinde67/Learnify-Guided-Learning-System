...
public class CFStudent extends JFrame {

    JPanel contentPanel;

    CFStudent() {

        setTitle("Computer Fundamentals Questions");
        ...
        JLabel heading = new JLabel("Computer Fundamentals Questions");
    ...
    void loadQuestions() {
        ...
        try {
            ...
            ResultSet rs = c.statement.executeQuery(
                "SELECT * FROM cf_questions ORDER BY id DESC"
            );
