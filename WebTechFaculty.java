...
public class WebTechFaculty extends JFrame implements ActionListener {
    ...
    WebTechFaculty() {
        ...
        setTitle("Upload Web Technology Question");
        setSize(1200, 700);
        setLayout(null);
        setLocation(600, 200);
        getContentPane().setBackground(new Color(255, 245, 247));

        JLabel heading = new JLabel("UPLOAD WEB TECHNOLOGY QUESTIONS");
        heading.setBounds(200, 20, 900, 50);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == submit) {
            ...
            try {
                ...
                String query = "INSERT INTO webtech_questions (question, answer) VALUES (?, ?)";
