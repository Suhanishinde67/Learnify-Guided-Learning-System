...
public class DBMSFaculty extends JFrame implements ActionListener {
    ...
    DBMSFaculty() {
        ...
        JLabel heading = new JLabel("UPLOAD DBMS QUESTIONS");
        heading.setBounds(300, 20, 650, 50);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == submit) {
            ...
            try {
                ...
                String query = "INSERT INTO dbms_questions (question, answer) VALUES (?, ?)";
