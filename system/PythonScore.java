...
public class PythonScore extends JFrame {

    PythonScore(String name, int score) {
        ...
        // 🔹 HEADING
        JLabel heading = new JLabel("YOU HAVE COMPLETED PYTHON MCQ TEST SUCCESSFULLY!!!");
        ...
        exit.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                //new StartLearning2(); // same as your original flow
                setVisible(false);
            }
        });

        // 🔹 ADD TO BACKGROUND (IMPORTANT!)
