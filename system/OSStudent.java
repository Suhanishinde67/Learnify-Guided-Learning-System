...
public class OSStudent extends JFrame {

    JPanel contentPanel;

    OSStudent() {

        setTitle("OS Questions");
        ...
        JLabel heading = new JLabel("IMPORTANT OPERATING SYSTEMS QUESTIONS");
    ...
    void loadQuestions() {
        ...
        try {
            ...
            ResultSet rs = c.statement.executeQuery(
                "SELECT * FROM os_questions ORDER BY id DESC"
            );
