...
public class OOPFaculty extends JFrame implements ActionListener {
    ...
    OOPFaculty() {
        ...
        setTitle("Upload OOPs Question");
        setSize(1200, 700);
        setLayout(null);
        setLocation(600, 200);
        getContentPane().setBackground(new Color(255, 245, 247));

        JLabel heading = new JLabel("UPLOAD OOPs QUESTIONS");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == submit) {
            ...
            try {
                ...
                String query = "INSERT INTO oops_questions (question, answer) VALUES (?, ?)";
