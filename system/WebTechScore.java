...
public class WebTechScore extends JFrame {

    WebTechScore(String name, int score) {
        ...
        JLabel heading = new JLabel("YOU HAVE COMPLETED WEB TECH MCQ TEST SUCCESSFULLY!!!");
        heading.setBounds(250, 300, 1500, 40);
