...
public class PracticeCoding extends JFrame implements ActionListener {
    ...
    PracticeCoding() {
        ...
        JLabel heading = new JLabel("Start Practicing Some Coding", JLabel.CENTER); 
        ...
        try {
            ...
            ResultSet rs = c.statement.executeQuery(
                "SELECT * FROM top100Codes ORDER BY id ASC LIMIT 25"
            );
