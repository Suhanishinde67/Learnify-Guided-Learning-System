...
public class OSFaculty extends JFrame implements ActionListener {
    ...
    OSFaculty() {
        ...
        setTitle("Upload OPERATING SYSTEMS Question");
        setSize(1200, 700);
        setLayout(null);
        setLocation(600, 200);
        getContentPane().setBackground(new Color(255, 245, 247));

        JLabel heading = new JLabel("UPLOAD OPERATING SYSTEMS QUESTIONS");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == submit) {
            ...
            try {
                ...
                String query = "INSERT INTO os_questions (question, answer) VALUES (?, ?)";
