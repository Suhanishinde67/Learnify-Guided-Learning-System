...
public class CFFaculty extends JFrame implements ActionListener {
    ...
    CFFaculty() {
        ...
        setTitle("Upload CF Question");
        setSize(1200, 700);
        setLayout(null);
        setLocation(600, 200);
        getContentPane().setBackground(new Color(255, 245, 247));

        JLabel heading = new JLabel("UPLOAD COMPUTER FUNDAMENTALS QUESTIONS");
        heading.setBounds(50, 20, 1100, 50);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == submit) {
            ...
            try {
                ...
                String query = "INSERT INTO cf_questions (question, answer) VALUES (?, ?)";
