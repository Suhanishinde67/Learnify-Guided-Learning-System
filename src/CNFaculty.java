...
public class CNFaculty extends JFrame implements ActionListener {
    ...
    CNFaculty() {
        ...
        setTitle("Upload COMPUTER NETWORKS Question");
        setSize(1200, 700);
        setLayout(null);
        setLocation(600, 200);
        ...
        JLabel heading = new JLabel("UPLOAD COMPUTER NETWORKS QUESTIONS");
        heading.setBounds(100, 20, 950, 50);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == submit) {
            ...
            try {
                ...
                String query = "INSERT INTO cn_questions (question, answer) VALUES (?, ?)";
            ...
            setVisible(false);
            // new Dashboard(); // optional navigation
        }
    }
